    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-number">
                    <% 
                        ...
                        if (salesSummary != null && salesSummary.get("totalRevenue") != null) {
                            BigDecimal revenue = (BigDecimal) salesSummary.get("totalRevenue");
                            out.print("Rs. " + (revenue != null ? revenue.toString() : "0"));
                        } else {
                            out.print("Rs. 0");
                        }
                    %>
            ...
            <div class="stat-card">
                <div class="stat-number">
                    <% 
                        if (salesSummary != null && salesSummary.get("totalBooksSold") != null) {
                            out.print(salesSummary.get("totalBooksSold").toString());
                        } else {
                            out.print("0");
                        }
                    %>
            ...
            <div class="stat-card">
                <div class="stat-number">
                    <% 
                        if (salesSummary != null && salesSummary.get("totalBills") != null) {
                            out.print(salesSummary.get("totalBills").toString());
                        } else {
                            out.print("0");
                        }
                    %>
        ...
        <div class="quick-actions">
            ...
            <div class="actions-grid">
                ...
                <a href="${pageContext.request.contextPath}/admin/items" class="btn">Manage Items</a>
                <a href="${pageContext.request.contextPath}/admin/reports" class="btn">View Reports</a>
