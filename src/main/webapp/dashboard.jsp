                    ...
                    <div class="card-body">
                        <div class="reports-grid">
                            <div class="report-item">
                                ...
                                <p>Generate detailed customer analysis and statistics</p>
                                <button onclick="printCustomerReport()" class="btn btn-primary">📋 Customer Report</button>
                            </div>
                            <div class="report-item">
                                <h4>Inventory Reports</h4>
                                <p>View book inventory status and stock levels</p>
                                <button onclick="printBookReport()" class="btn btn-success">📚 Book Report</button>
                            </div>
                            <div class="report-item">
                                <h4>Sales Reports</h4>
                                <p>Analyze billing data and revenue statistics</p>
                                <button onclick="printBillReport()" class="btn btn-warning">🧾 Bill Report</button>
                            </div>
                            <div class="report-item">
                                <h4>Business Summary</h4>
                                <p>Comprehensive overview of all business metrics</p>
                                <button onclick="printSalesSummaryReport()" class="btn btn-info">📊 Summary Report</button>
                            </div>
                        </div>
                    </div>
                </div>
