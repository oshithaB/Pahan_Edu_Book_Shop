...
function setupAutocomplete(inputId, type, onSelectCallback) {
    ...
    function showSuggestions(suggestions) {
        ...
        // Position suggestions above input if not enough space below
        if (spaceBelow < 200 && spaceAbove > 200) {
            suggestionsDiv.style.top = 'auto';
            suggestionsDiv.style.bottom = '100%';
            suggestionsDiv.style.borderTop = '1px solid #ddd';
            suggestionsDiv.style.borderBottom = 'none';
            suggestionsDiv.style.borderRadius = '4px 4px 0 0';
        } else {
            suggestionsDiv.style.top = '100%';
            suggestionsDiv.style.bottom = 'auto';
            suggestionsDiv.style.borderTop = 'none';
            suggestionsDiv.style.borderBottom = '1px solid #ddd';
